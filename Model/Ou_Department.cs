...
namespace Model
{
    ...
    public partial class Ou_Department
    {
        ...
        {
            this.Ou_Department1 = new HashSet<Ou_Department>();
        ...
        public virtual ICollection<Ou_Department> Ou_Department1 { get; set; }
        public virtual Ou_Department Ou_Department2 { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
